...
* Works well with other packages, such as `renv`, Quarto, R Markdown, Shiny, `pins`, and `vetiver`.

## Live demo

* Code: <https://github.com/wlandau/targets-four-minutes>
* Helpful practice:
    1. Start with [`R/functions.R`](https://github.com/wlandau/targets-four-minutes/blob/main/R/functions.R).
